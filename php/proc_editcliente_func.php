<?php 
    ...
    // Select para pegar o id_endereco da Tabela cliente
    $result = "SELECT * from cliente WHERE cpf = '$cpf'";
    ...
    if($valido2){
        ...
        $insert1 = "UPDATE cliente SET nome = '$nome', sobrenome = '$sobrenome', data_nasc = '$data_nasc' WHERE cpf = '$cpf'";
        ...
        if(($v1 + $v2 + $v3) >= 1){
            ...
            header("Location: edit_cliente_funcionario.php");
        }else {
