								...
								<h1 style="font-weight: 600;">Seu Cadastro</h1><br>
									...
									<div class="form-row"> 
									  <div class="form-group col-md-5">
										...
										<input required type="text" name="cpf" id="cpf" class="form-control" placeholder="000.000.000-00" autofocus oninput="this.value = this.value.replace(/[^0-9\.-]/g, '').replace(/(.*)/g, '$1');">
										<div class="invalid-feedback">
										  CPF válido
										</div>
									  </div>
									  ...
									  <label for="rg">RG </label>
										<input required type="text" name="rg" id="rg" class="form-control" placeholder="00.000.000-0" autofocus oninput="this.value = this.value.replace(/[^0-9\.-]/g, '').replace(/(.*)/g, '$1');">
										<div class="invalid-feedback">
										  RG válido
										</div>
									  </div>
