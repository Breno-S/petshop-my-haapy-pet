                                    ...
                                    <div class="form-body">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input id="nomeCompleto" type="text" class="form-control" name="nomeCompleto" value="<?php echo($informacoes_cliente['nome'] .' '. $informacoes_cliente['sobrenome']) ?>" readonly required autofocus>
